...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.ivan.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service.ivan.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.ivan
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi-service-lazy.ivan.rc \
    android.hardware.wifi-service.ivan.xml
